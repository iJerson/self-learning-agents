...
- Prefer extending an existing pattern in the codebase over introducing a new one. Flag it explicitly if you think a new pattern is genuinely warranted, and say why.
